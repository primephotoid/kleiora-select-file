    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--line)] bg-[color:var(--surface-glass)] backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-6xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a href={`https://wa.me/6285752528300?text=${encodeURIComponent('Halo Minra, Saya ingin bertanya?')}`} className="hidden items-center gap-2 rounded-full bg-[var(--gold)] px-6 py-2.5 text-sm font-bold text-white transition hover:bg-[var(--gold-dark)] md:inline-flex">
